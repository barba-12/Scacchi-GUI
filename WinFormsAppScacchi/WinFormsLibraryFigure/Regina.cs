    ...
    public override List<List<List<int>>> checkMovimeto(int row, int col)
    {
        ...
        for (int i = 1; i < 8; i++)
        {
            ...
            if ((row + i <= 7 && col + i <= 7) && (row + i >= 0 && col + i >= 0))
            {
                ...
                {
                    if (Partita.MatriceScacchiera[row + i, col + i] != null && Partita.MatriceScacchiera[row + i, col + i].Colore != colore && check[4] == true)
                    {
                        listaCelleMangiabili.Add(new List<int>());
                        listaCelleMangiabili[listaCelleMangiabili.Count - 1].Add(row + i);
                        listaCelleMangiabili[listaCelleMangiabili.Count - 1].Add(col + i);
            ...
            if ((row - i <= 7 && col - i <= 7) && (row - i >= 0 && col - i >= 0))
            {
                ...
                {
                    if (Partita.MatriceScacchiera[row - i, col - i] != null && Partita.MatriceScacchiera[row - i, col - i].Colore != colore && check[5] == true)
                    {
                        listaCelleMangiabili.Add(new List<int>());
                        listaCelleMangiabili[listaCelleMangiabili.Count - 1].Add(row - i);
                        listaCelleMangiabili[listaCelleMangiabili.Count - 1].Add(col - i);
            ...
            if ((row + i <= 7 && col - i <= 7) && (row + i >= 0 && col - i >= 0))
            {
                ...
                {
                    if (Partita.MatriceScacchiera[row + i, col - i] != null && Partita.MatriceScacchiera[row + i, col - i].Colore != colore && check[6] == true)
                    {
                        listaCelleMangiabili.Add(new List<int>());
                        listaCelleMangiabili[listaCelleMangiabili.Count - 1].Add(row + i);
                        listaCelleMangiabili[listaCelleMangiabili.Count - 1].Add(col - i);
            ...
            if ((row - i <= 7 && col + i <= 7) && (row - i >= 0 && col + i >= 0))
            {
                ...
                {
                    if (Partita.MatriceScacchiera[row - i, col + i] != null && Partita.MatriceScacchiera[row - i, col + i].Colore != colore && check[7] == true)
                    {
                        listaCelleMangiabili.Add(new List<int>());
                        listaCelleMangiabili[listaCelleMangiabili.Count - 1].Add(row - i);
                        listaCelleMangiabili[listaCelleMangiabili.Count - 1].Add(col + i);
